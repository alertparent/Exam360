...
ActiveRecord::Schema.define(version: 20140602212433) do
  ...
  add_index "categorysubjects", ["category_id", "subject_id"], name: "by_category_and_subject", unique: true, using: :btree
  ...
  add_index "examquestions", ["exam_id", "question_id"], name: "by_exam_and_question", unique: true, using: :btree
  ...
  add_index "shared_folders", ["user_id", "shared_user_id", "folder_id"], name: "by_user_id_and_shared_user_id_and_folder_id", unique: true, using: :btree
  ...
  add_index "shared_questions", ["question_id", "user_id"], name: "by_question_and_user", unique: true, using: :btree
  ...
  add_index "subjects", ["name", "category_id"], name: "by_name_and_category", unique: true, using: :btree
