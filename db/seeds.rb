...
Setting.create!( :allow_examinee_registration => true, :confirm_exam=> true, :datetime_format=>'%m/%d/%Y', :locale=>'en', :show_hint_to_examinee => true ) if Setting.all.count == 0
...
# end
 ...
 ["school", "university/college", "organization","training_center"].each do |r|  
   Organization.find_or_create_by(:title=> r)  
 end 
...
<hr>
Thanks & Regards,<br>
<b>Exam360 Team</b><br>*t3*User Name <=> $^_username_^$*Liebe $^_username_^$,<br><br>
...
"Dear $^_username_^$,<br><br>
Your account has been created with Exam360.<br><br>
...
<hr>
Thanks & Regards,<br>
<b>Exam360 Team</b><br>*t4*User Name <=> $^_username_^$<br>  User Login <=> $^_userlogin_^$<br>  Verify Email and Password link <=> $^_verify_and_set_password^$*Liebe $^_username_^$,<br><br>
Ihr Konto wurde mit Exam360 geschaffen.<br><br>
...
Danke & Grüße,<br>
<b>Exam360 Team</b><br>*العزيز $^_username_^$,<br><br>
لقد تم إنشاء حسابك مع Exam360.<br><br>
...
<hr>
Thanks & Regards,<br>
<b>Exam360 Team</b><br>*t5*User Name <=> $^_username_^$<br> Reset Password Link <=> $^_reset_url_^$*Liebe $^_username_^$,<br><br>
...
<hr>
Thanks & Regards,<br>
<b>Exam360 Team</b><br>*t8*User Name <=> $^_username_^$*Liebe $^_username_^$,<br><br>
...
<hr>
感謝和問候,<br>
<b>Exam360 團隊</b><br>"] .each do |email|  
